ggradar2 <- function (plot.data, font.radar = "Arial", values.radar = c("0%", 
  ...
  base <- base + theme(legend.key.width = unit(3, "line")) + 
    ...
    theme(legend.text = element_text(size = legend.text.size), 
          legend.position = "left") + theme(legend.key.height = unit(2, 
                                                                     "line")) + scale_colour_manual(values = rep(c("#FF5A5F", 
                                                                                                                   "#FFB400", "#007A87", "#8CE071", "#7B0051", "#00D1C1", 
                                                                                                                   "#FFAA91", "#B4A76C", "#9CA299", "#565A5C", "#00A04B", 
                                                                                                                   "#E54C20"), 100)) + theme(text = element_text(family = font.radar)) + 
